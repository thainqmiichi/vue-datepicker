                ...
                >
                    <template v-for="(type, i) in selectionButtonsDisplay" :key="type.type">
                        ...
                        >
                            ...
                            />
                            <template v-if="!$slots[type.type]">{{ type.type !== 'year' ? type.text : getJapaneseEra(type.text) }}</template>
                        </button>
...
<script lang="ts" setup>
    ...
    import { checkKeyDown, checkMinMaxValue, formatNumber, groupListAndMap, unrefElement, getJapaneseEra } from '@/utils/util';
